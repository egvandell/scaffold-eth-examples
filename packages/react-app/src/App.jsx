...
const defaultTargetNetwork = NETWORKS.goerli; // <------- select your target frontend network (localhost, rinkeby, xdai, mainnet)
...
function App(props) {
  ...
  const networkOptions = ["localhost", "mainnet", "kovan"];
      ...
      <Switch>
        ...
        <Route exact path="/debug">
          {/*
                ...
                each of these <Contract/> components will automatically parse your ABI
